...
func (m *MockkafkaProxy) LowWaterMark(topic string) (int64, error) {
	ret := m.ctrl.Call(m, "LowWaterMark", topic)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockkafkaProxyMockRecorder) LowWaterMark(topic interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LowWaterMark", reflect.TypeOf((*MockkafkaProxy)(nil).LowWaterMark), topic)
}

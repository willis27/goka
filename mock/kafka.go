...
func (m *MockConsumer) LowWaterMark(arg0 string, arg1 int32) (int64, error) {
	ret := m.ctrl.Call(m, "LowWaterMark", arg0, arg1)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockConsumerMockRecorder) LowWaterMark(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LowWaterMark", reflect.TypeOf((*MockConsumer)(nil).LowWaterMark), arg0, arg1)
}
